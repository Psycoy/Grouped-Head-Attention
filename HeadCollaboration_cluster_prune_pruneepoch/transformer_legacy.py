...
@register_model("efficient_transformer")
...
@register_model_architecture("efficient_transformer", "transformer_tiny_cus")
...
@register_model_architecture("efficient_transformer", "efficient_transformer")
def base_architecture(args):
    ...
    args.efficient_multihead_attention = getattr(args, "efficient_multihead_attention", False)
    args.bias_mode_k = getattr(args, "bias_mode_k", "bias_trainable")
    args.share_kbias_across_encoder_decoder = getattr(args, "share_kbias_across_encoder_decoder", False)
    args.share_kbias_across_layers = getattr(args, "share_kbias_across_layers", False)


@register_model_architecture("efficient_transformer", "transformer_iwslt_de_en_cus")
...
@register_model_architecture("efficient_transformer", "transformer_wmt_en_de_cus")
def transformer_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("efficient_transformer", "transformer_vaswani_wmt_en_de_big_cus")
...
@register_model_architecture("efficient_transformer", "transformer_vaswani_wmt_en_fr_big_cus")
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, "dropout", 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture("efficient_transformer", "transformer_wmt_en_de_big_cus")
...
@register_model_architecture("efficient_transformer", "transformer_wmt_en_de_big_t2t_cus")
