...
class CommonConfig(FairseqDataclass):
    ...
    debug_mode: bool = field(
        default=False, metadata={"help": "Whether it is in debug mode."}
    )
    ...
    wandb_runname: Optional[str] = field(
        default=None,
        metadata={"help": "wandb run name to use for logging"},
    )
    
    wandb_runid: Optional[str] = field(
        default=None,
        metadata={"help": "wandb run id to use for logging"},
    )
    
    wandb_runtags: Optional[str] = field(
        default=None,
        metadata={"help": "wandb run tags to use for logging"},
    )
    
    wandb_runnotes: Optional[str] = field(
        default=None,
        metadata={"help": "wandb run notes to use for logging"},
    )
    ...
    experiment_stage: ChoiceEnum(['train', 'valid', 'test']) = field(
        default='train',
        metadata={"help": "Which stage it is."},
    )
...
class DatasetConfig(FairseqDataclass):
    ...
    batch_size_valid: Optional[int] = field(
        ...
        metadata={
            ...
            "argparse_alias": "--max_sentences_valid",
        },
    )
...
class GenerationConfig(FairseqDataclass):
    ...
    retain_eos: bool = field(
        default=False,
        metadata={"help": "if set, retain eos when generating real string."},
    )
    
    plot_scatter: bool = field(
        default=False,
        metadata={"help": "Whether to plot scatter and exit."},
    )
