...
@dataclass
class AdaptiveLossConfig_headclustering(FairseqDataclass):
...
@register_criterion("adaptive_loss_headclustering", dataclass=AdaptiveLossConfig_headclustering)
class AdaptiveLoss_headclustering(FairseqCriterion):
    """This is an implementation of the loss function accompanying the adaptive softmax approximation for
    graphical processing units (GPU), described in the paper "Efficient softmax approximation for GPUs"
    (http://arxiv.org/abs/1609.04309)."""

    def __init__(self, task, sentence_avg, cfg=AdaptiveLossConfig_headclustering):
        super().__init__(task)
        self.cfg=cfg
    ...
    @classmethod
    def build_criterion(cls, cfg: AdaptiveLossConfig_headclustering, task):
