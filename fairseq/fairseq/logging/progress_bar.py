...
def progress_bar(
    ...
    wandb_run_tags: Optional[str] = None,
    ...
    if wandb_project:
        bar = WandBProgressBarWrapper(bar, wandb_project, run_name=wandb_run_name, run_id=wandb_run_id, run_tags=wandb_run_tags, run_notes=wandb_run_notes, resume=resume)
...
class WandBProgressBarWrapper(BaseProgressBar):
    ...
    def __init__(self, wrapped_bar, wandb_project, run_name=None, run_id=None, run_tags=None, run_notes=None, resume=None):
        self.wrapped_bar = wrapped_bar
        if wandb is None:
        ...
        wandb.init(project=wandb_project, reinit=False, name=run_name, id=run_id, tags=run_tags, notes=run_notes, resume=resume)
    ...
    def _log_to_wandb(self, stats, tag=None, step=None):
        ...
        for key in stats.keys() - {"num_updates"}:
            if isinstance(stats[key], AverageMeter):
                ...
                print("Logging ", {prefix + key: stats[key]}, "at step ", step, "to wandb...")
