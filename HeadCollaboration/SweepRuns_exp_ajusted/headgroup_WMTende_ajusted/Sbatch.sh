...
#SBATCH -p RTXA6Kq -w node08               # TODO change the node if not available
#SBATCH -n 1
...
then
    ...
    echo "0" > "./Experimental_Results/${name}/_Train_Counter.txt"    # TODO change this line if you want to resume
else
